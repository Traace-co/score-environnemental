export function Introduction() {
  return (
    <div className="flex flex-col gap-2">
      ...
      <div>
        Lien vers le modèle de l'Ademe (y compris les facteurs d'émissions utilisés) : <a className="text-blue-600" href="https://www.consultations-publiques.developpement-durable.gouv.fr/IMG/pdf/20230713_arrete_methodologie_critere_environnemental_v7clean.pdf">[lien]</a>
      </div>
    </div>
  )
}